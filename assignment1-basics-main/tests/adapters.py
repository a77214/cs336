...
def run_multihead_self_attention(
    ...
    """
    mha = CausalMultiHeadSelfAttention(d_model=d_model, num_heads=num_heads, device=in_features.device,
...
def run_transformer_block(
    ...
    token_position = torch.arange(seq_len, device=in_features.device, dtype=torch.long).view(1, seq_len).expand(batch,
                                                                                                                seq_len)
